      ...
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 md:p-10 transition-all duration-300">
        ...
        <div className="relative my-6">
          ...
          <div className="relative flex justify-center text-sm">
            <span className="px-4 bg-white text-gray-500">O entra con</span>
          </div>
        </div>
...
const RegisterPage = () => {
  ...
  return (
    <div className="h-screen flex items-center justify-center bg-gradient-to-br from-blue-50 via-white to-green-50 px-4">
      <div className="relative bg-white rounded-3xl shadow-2xl w-full max-w-md p-8 md:p-10 transition-all duration-300 h-[90vh] flex flex-col overflow-y-auto">
        
        {/* HEADER SUPERIOR */}
        <div className="sticky top-6 left-0 right-0 flex items-center justify-between bg-white z-10 pb-2">
          {/* Logo + Nombre */}
          <div className="flex items-center gap-3">
            <div
              className="w-10 h-10 rounded-lg flex items-center justify-center text-white font-bold shadow-md"
        ...
        <div className="flex-1 overflow-y-auto mt-8">
          ...
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold leading-tight" style={{ color: colors.primary }}>
              Crear tu cuenta
            </h2>
